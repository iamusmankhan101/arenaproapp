...
/**
 * FALLBACK THEME - Uses only Montserrat fonts
 * 
 * Use this theme if ClashDisplay fonts are not available.
 * To activate: Replace the import in App.js from './src/theme/theme' to './src/theme/theme.fallback'
 */
...
export const theme = {
  ...
  fonts: {
    ...MD3LightTheme.fonts,
    // All fonts use Montserrat as fallback
    default: {
