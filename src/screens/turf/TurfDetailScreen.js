...
export default function TurfDetailScreen({ route, navigation }) {
  ...
  // Normalize sports data before transforming venue with safe checks and error handling
  ...
  try {
    ...
    console.error('❌ Error normalizing sports data:', error);
    console.log('Raw venue data:', JSON.stringify(rawVenue, null, 2));
