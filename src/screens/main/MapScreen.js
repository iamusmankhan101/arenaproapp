                    ...
                    <View style={styles.venueHeader}>
                      <View style={styles.ratingContainer}>
                        ...
                        <Text style={styles.ratingText}>
                          {venue.rating ? String(venue.rating.toFixed(1)) : 'New'}
                        </Text>
                      </View>
                    </View>
            ...
            <TouchableOpacity onPress={() => handleVenueCardPress(selectedVenue)}>
              ...
              <Card.Content style={styles.cardContent}>
                <View style={styles.cardHeader}>
                  <Text style={styles.selectedVenueName}>{String(selectedVenue.name || 'Venue')}</Text>
                ...
                <View style={styles.selectedVenueInfo}>
                  ...
                  <Text style={styles.selectedVenueAddress} numberOfLines={1}>
                    {String(getVenueAddress(selectedVenue))}
                  </Text>
                </View>
                ...
                <View style={styles.selectedVenueFooter}>
                  <View style={styles.rating}>
                    <MaterialIcons name="star" size={16} color="#FFD700" />
                    <Text style={styles.ratingText}>
                      {selectedVenue.rating ? String(selectedVenue.rating.toFixed(1)) : 'New'}
                    </Text>
                  </View>
                  <Text style={styles.price}>{`Rs. ${String(selectedVenue.pricePerHour || selectedVenue.pricing?.basePrice || 0)}/hr`}</Text>
                </View>
              </Card.Content>
            </TouchableOpacity>
          </Card>
